...
public class BST<Key extends Comparable<Key>, Value> {
    ...
    private Node floor(Node x, Key key) {
        ...
        // key > x.key的时候，可能要找的节点就是当前节点，也可能在右子树里面，所以在下面分情况讨论
    ...
    /* 在这个版本中，函数签名直接记录了best，相当于每次递归的时候都记住了先前的最优值，那么在处理完成右子树后不再需要回来考虑父节点
    对于其他需要记录中间状态的问题，也可以涉及类似的函数签名
     */
    ...
    private void keys(Node x, Queue<Key> queue, Key lo, Key hi) {
        ...
        // 核心处理逻辑是下面这行，如果当前节点的key在返回内，就加到queue里面，剩下的就是递归处理左右子树
