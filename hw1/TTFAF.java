...
//         player.play();
    ...
    /* TTFAF本质上是一个.mid文件，上面的main方法中用Base64将这个文件解码，并用GZIPInputStream解压出了对应的二进制数据
    MIDI（Musical Instrument Digital Interface）文件是一种数字乐谱，而非音频文件。它记录了音乐演奏的指令，而非实际声音波形
     */
